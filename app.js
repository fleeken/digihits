...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("sw.js?v=6.02", { updateViaCache: "none" }).then((registration) => registration.update()).catch(() => {});

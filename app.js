...
const avatarStyles = ["Pop", "Rock", "Hiphop", "Elektroniskt", "Country", "Indie"];
function renderAvatar() {
  ...
  const genreClass = genre.toLowerCase().replace("hiphop", "hiphop").replace("elektroniskt", "elektroniskt");

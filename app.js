...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("sw.js?v=5.95", { updateViaCache: "none" }).then((registration) => registration.update()).catch(() => {});

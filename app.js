...
document.addEventListener("click", (event) => { const remove = event.target.closest("[data-room-remove]"); if (!remove) return; remove.closest(".room-player-row").remove(); renumberRoomPlayers(); clearRoomPlayerError(); });

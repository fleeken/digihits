...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("sw.js?v=6.05", { updateViaCache: "none" }).then((registration) => registration.update()).catch(() => {});

...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("sw.js?v=6.03", { updateViaCache: "none" }).then((registration) => registration.update()).catch(() => {});

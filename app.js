...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("sw.js?v=6.13", { updateViaCache: "none" }).then((registration) => registration.update()).catch(() => {});

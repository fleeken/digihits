...
function ownAvatarChoice() { return avatarChoice({ ...(state.avatar || {}), user_id: state.avatar?.user_id || state.userId, display_name: state.playerName }); }
